...
/* Transmit & Receive Operations: Page 55, RTL8180L Datasheet*/
...
/* A technique used on token-passing networks for monitoring the status of the 
 * token-passing process. Beaconing is used in token ring and Fiber Distributed 
 * Data Interface (FDDI) networks to ensure that token passing is functioning 
 * properly.
 */
struct rtl8180_vif {
